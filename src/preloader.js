...
export default new Phaser.Class({
    ...
    preload: function ()
    {
        ...
        this.load.image('cinema-top', 'assets/invisible/cinema.png');
        ...
        this.load.image('end-house', 'assets/endHouse.png');
        this.load.image('win-background', 'assets/winBackground.png');
